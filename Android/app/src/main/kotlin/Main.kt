...
internal val logger: SkipLogger = SkipLogger(subsystem = "ibunny.sparks", category = "IBunnySparks")

private typealias AppRootView = IBunnySparksRootView
private typealias AppDelegate = IBunnySparksAppDelegate
